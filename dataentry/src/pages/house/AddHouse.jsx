...
const AddHouse = () => {
  ...
  'FCT (Federal Capital Territory)': ['Abaji', 'Bwari', 'Gwagwalada', 'Kuje', 'Kwali', 'Municipal Area Council'],
  ...
  return (
    <div>
      ...
      <div className="">
									...
									<input required className="p-3 rounded bg-slate-200 block w-full"  type="text" name="ward"/>
								</div>       
                ...
                <div className="">
									...
									<input required className="p-3 rounded bg-slate-200 block w-full"  type="text" name="street"/>
								</div> 
                ...
                <div className="">
									...
									<input required className="p-3 rounded bg-slate-200 block w-full"  type="text" name="number"/>
								</div> 
